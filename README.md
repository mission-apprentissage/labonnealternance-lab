...
make dev-up        # Start with live reload (development)
...
```shell
$ curl http://172.17.0.2:8000/model/score -X POST -H 'Content-Type: application/json' -d '{"text": "Développeur / Développeuse web"}'
